...
public final class ConnectionFactory implements ConfiguredFactory<Connection> {

    private final Config config;

    public ConnectionFactory(final Config config) {
        this.config = config;
    }

    @Override
    public Connection configured() {
        return new LazyConnection(config).get();
    }
}
